...
* The original package name 'com.example.microservices-messaging-producer' is invalid and this project uses 'com.example.microservices_messaging_producer' instead.
...
* [Spring for RabbitMQ](https://docs.spring.io/spring-boot/3.5.10-SNAPSHOT/reference/messaging/amqp.html)
