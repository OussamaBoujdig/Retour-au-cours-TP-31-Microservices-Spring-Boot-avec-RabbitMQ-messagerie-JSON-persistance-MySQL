...
* The original package name 'com.example.microservices-messaging-consumer' is invalid and this project uses 'com.example.microservices_messaging_consumer' instead.
